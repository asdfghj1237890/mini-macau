        ...
        <div className="flex items-stretch border-b border-white/10">
          <div className="px-3 py-2 flex items-center gap-2 border-r border-white/10"
            ...
            <div>
              ...
              <div className="mm-mono text-[13px] font-bold text-white leading-tight">
                WC
              </div>
            </div>
          </div>
          <div className="flex-1 px-3 py-2 flex flex-col justify-center min-w-0">
            ...
            {toilet.closed && (
              <div className="mm-mono text-[9px] max-sm:text-[7px] tracking-[0.2em] text-white/45 truncate">
                {t.toiletClosed}
              </div>
            )}
          </div>
